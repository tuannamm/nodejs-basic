...
const {getAllCustomers, postCreateCustomer, postCreateListCustomers, putUpdateCustomer, deleteCustomer, deleteCustomers } = require("../controllers/customerController");
